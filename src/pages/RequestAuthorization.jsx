              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-4">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-amber-800">Please do not include gate codes, access codes, combinations, key locations, or other security information on this form. We do not keep records of this nature for security reasons. Please only share this info with individual technicians.
